// federalRidings.js — Federal riding layer, config-driven
...
export async function initFederalRidings(map, config) {
  ...
  try {
    const geoResponse = await fetch(config.federalBoundaryFile);
